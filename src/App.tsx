      ...
      <BrowserRouter>
        <AuthProvider>
          <Routes>
            ...
            <Route path="/nova" element={<ProtectedRoute><StrategyBuilderPage /></ProtectedRoute>} />
            <Route path="/estrategia/:id" element={<ProtectedRoute><StrategyBuilderPage /></ProtectedRoute>} />
